...
let jeudi = ["aucun","aucun","aucun","aucun","aucun","IT-I2D","SPC","aucun","aucun"]
let vendredi = ["aucun","aucun","Français","aucun","aucun","aucun","aucun","aucun","aucun"]
...
client.on("ready", ()=>{
    ...
    var msg_on = client.channels.cache.get("694972812510625873");
...
client.on("message", message =>{
    ...
    if(message.channel.id === `694972812510625873`){
    var msg_rep = client.channels.cache.get("694972812510625873");
...
function time(){
    ...
    if(horaire ==="17:50"){
    var msg_embed = client.channels.cache.get("694972812510625873");
    const embed = new MessageEmbed()
      // Set the title of the field
      .setTitle('Agenda 1STI2D')
      // Set the color of the embed
